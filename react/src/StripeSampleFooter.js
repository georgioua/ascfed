            ...
            <div className="flex items-center justify-between flex-wrap">
              <div className="w-full flex-1 flex items-center sm:w-0">
                <p className="text-white truncate">
                  <strong className="text-gray-600 font-medium md:hidden">
                    Australain Sports Capoeira Federation
                  </strong>
                  <strong className="hidden md:inline font-medium text-gray-600">
                    Australain Sports Capoeira Federation
                  </strong>
              ...
              <div className="flex-shrink-0">
                <div className="rounded-md shadow-sm">
                  <a
                    href="https://ascfed.org/?page_id=496"
                    className="flex items-center justify-center px-4 py-2 border text-sm leading-5 font-medium rounded text-blue-600 bg-white hover:text-gray-600 focus:outline-none focus:shadow-outline transition ease-in-out duration-150"
                  >
                    View Members Benefits →
                  </a>
                </div>
              </div>
            </div>
